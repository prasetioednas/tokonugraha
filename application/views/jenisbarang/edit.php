    ...
    <div class="col-md-8">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">UPDATE DATA JENIS</h3>
        </div>
        <!-- /.box-header -->
        <?php 
        foreach ($get as $a): ?>
        <div class="box-body">
          <!-- /.box-header -->
          <form action="<?php echo site_url('jenis/action_update');?>" method="POST">
            <div class="box-body" id="view">
              ...
              <div class="form-group has-feedback">
                <input type="hidden" value="<?= $this->uri->segment(3) ?>" class="form-control" name="id_jenis" value="<?= $a->id_jenis;?>">
              </div>
              <div class="form-group has-feedback">
                <input type="text" name="nama_jenis" class="form-control" value="<?= $a->nama_jenis;?>">
              </div>
