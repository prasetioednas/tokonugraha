...
<div class="wrapper">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php if ($this->uri->segment('1') == 'jenisbarang') {echo 'active';} ?>"><a href="#">Jenis Barang</a></li>
            <li class="<?php if ($this->uri->segment('1') == 'databarang') {echo 'active';} ?>"><a href="#">Data Barang</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Satuan Barang</a></li>
    ...
    <div class="col-md-8">
      <div class="box">
        <div class="box-header">
          <h3 class="box-title">UPDATE DATA SATUAN</h3>
        </div>
        <!-- /.box-header -->
        <?php 
        foreach ($get as $a): ?>
        <div class="box-body">
          <!-- /.box-header -->
          <form action="<?php echo site_url('satuan/action_update');?>" method="POST">
            <div class="box-body" id="view">
              ...
              <div class="form-group has-feedback">
                <input type="hidden" value="<?= $this->uri->segment(3) ?>" class="form-control" name="id_satuan" value="<?= $a->id_satuan;?>">
              </div>
              <div class="form-group has-feedback">
                <input type="text" name="nama_satuan" class="form-control" value="<?= $a->nama_satuan;?>">
              </div>
