  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-8">
      <div class="box">
        ...
        <div class="box-body">
          <!-- /.box-header -->
          <form action="<?php echo site_url('user/action_update');?>" method="POST">
            ...
            <div class="box-body" id="view">
              ...
              <div class="form-group has-feedback">
                <input type="hidden" class="form-control" name="id_user" value="<?= $a->id_user;?>">
              </div>
              <div class="form-group has-feedback">
              ...
              <div class="form-group has-feedback">
              <input value="admin" <?= set_radio('role', 'admin'); ?> type="radio" id="admin" name="role" class="custom-control-input" <?php echo ($a->role == 'admin' ? ' checked' : ''); ?>> Admin
              <input value="gudang" <?= set_radio('role', 'gudang'); ?> type="radio" id="gudang" name="role" class="custom-control-input" <?php echo ($a->role == 'gudang' ? ' checked' : ''); ?>> Gudang
              </div>
