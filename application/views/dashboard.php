        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?= $namanya; ?></span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#"><i class="fa fa-folder"></i> <span>Barang</span>
...
<script type="text/javascript">
        ...
        $(document).on('change', '#barang_id', function() {
            let url = '<?= base_url()?>index.php/barangmasuk/getstok/' + this.value;
            // console.logxss(url);
...
<script type="text/javascript">
    ...
    //     text: "Klik Logout dibawah jika anda yakin ingin Logout!",
    //     type: "warning",
...
//     Swal.fire(
//       'Logout!',
//       'Anda berhasil Logout dari halaman ini.',
//       'success'
//     )
//   }
// })
