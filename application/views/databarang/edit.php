  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <!-- Optionally, you can add icons to the links -->
        <li class="<?php if ($this->uri->segment('1') == 'barangmasuk') {echo 'active';} ?>"><a href="#"><i class="fa fa-download"></i> <span>Barang Masuk</span></a></li>
        <li class="<?php if ($this->uri->segment('1') == 'barangkeluar') {echo 'active';} ?>"><a href="#"><i class="fa fa-upload"></i> <span>Barang Keluar</span></a></li>
      </ul>
      <ul class="sidebar-menu" data-widget="tree">
        <li class="header">SETTINGS</li>
        <!-- Optionally, you can add icons to the links -->
        <li class="<?php if ($this->uri->segment('1') == 'user') {echo 'active';} ?>"><a href="#"><i class="fa fa-user-plus"></i> <span>User Management</span></a></li>
  ...
  <div class="content-wrapper">
    ...
    <div class="col-md-8">
      <div class="box">
        ...
        <div class="box-body">
          <!-- /.box-header -->
          <form action="<?php echo site_url('databarang/action_update');?>" method="POST">
            ...
            <?= form_open('', [], ['stok' => 0, 'id_barang' => $barang['id_barang']]); ?>
              ...
              <div class="form-group has-feedback">
                <input type="hidden" value="<?= $this->uri->segment(3) ?>" class="form-control" name="id_barang" value="<?= $a->id_barang;?>">
              </div>
              <div class="form-group has-feedback">
                <input type="text" name="nama_barang" class="form-control" value="<?= $a->nama_barang;?>">
              </div>
              <div class="form-group has-feedback">
              <select name="jenis_id" id="jenis_id" class="form-control">
                                <option value="" selected disabled>Pilih Jenis Barang</option>
                                <?php foreach ($jenis1->result() as $a): ?>
                                    <option <?= $barang1['jenis_id'] == $a['id_jenis'] ? 'selected' : ''; ?> <?= set_select('jenis_id', $a['id_jenis']) ?> value="<?= $a['id_jenis'] ?>"><?= $a['nama_jenis'] ?></option>
                    <?php endforeach; ?>
                            </select>
              </div>
              <!-- <div class="form-group has-feedback">
